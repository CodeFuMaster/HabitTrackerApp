...
namespace HabitTrackerApp.Core.Models
{
    ...
    public class Habit
    {
        ...
        public ICollection<DailyHabitEntry> DailyHabitEntries { get; set; } = new List<DailyHabitEntry>();
        public ICollection<RoutineSession> RoutineSessions { get; set; } = new List<RoutineSession>();
        public ICollection<HabitMetricDefinition> MetricDefinitions { get; set; } = new List<HabitMetricDefinition>();
